...
class AuthController {
    login(req, res) {
        ...
        accountModel.login(username, password, (status, result, message, UserID, HouseID, accessToken, refreshToken, role) => {
            authView.login(res, status, result, message, UserID, HouseID, accessToken, refreshToken, role)
        })
    }
